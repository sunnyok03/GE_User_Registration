...
public class Main {
    public static void main(String[] args) {
        ...
        //As a User need to enter a valid password of min 8 length,1 capital,1 number,1 special char
        UserRegistration UC8 = new UserRegistration();
        System.out.println(UC8.validatePassword("aBc1ef?h")); // true
        System.out.println(UC8.validatePassword("910A10")); // false
    }
}